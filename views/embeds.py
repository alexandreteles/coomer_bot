...
async def loading_more_pictures_embed() -> discord.Embed:
    embed = discord.Embed(
...
async def generated_image_embed(image_data) -> discord.Embed:
    ...
    embed.add_field(name="CFG scale", value=image_data["params"]["cfg_scale"], inline=True)
    embed.add_field(name="Generation steps", value=image_data["params"]["steps"], inline=True)
    embed.add_field(name="Sampler", value=image_data["params"]["sampler_name"], inline=True)
    embed.add_field(
        name="Model",

...
prompt_prefix: str = "masterpiece, best quality, good anatomy, high quality, highres, high resolution, "
...
icon_base_url: str = f"{base_coomer}/icons"
banner_base_url: str = f"{base_coomer}/banners"
user_base_url: str = f"{base_coomer}/api"
